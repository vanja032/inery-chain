 ...
 * @ingroup contracts
 * @ingroup types
 * @brief Defines contract type which is %base class for every INERY contract
 */
 ...
 * @ingroup contract
 */
#define CONTRACT class [[inery::contract]]
#define ACTION   [[inery::action]] void
#define TABLE struct [[inery::table]]

namespace inery {

/**
 * %Base class for INERY contract.
 *
 * @ingroup contract
 * @details %A new contract should derive from this class, so it can make use of INERY_ABI macro.
 */
class contract {
   public:
      /**
