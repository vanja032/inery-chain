...
namespace  inery {
    ...
    *  @ingroup contracts
    *  @brief Defines INERY Singleton Table used with %multiindex
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         INELIB_SERIALIZE( row, (value) )
      };

      typedef inery::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            inery::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
