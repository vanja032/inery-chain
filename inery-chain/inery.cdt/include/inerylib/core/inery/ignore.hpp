...
namespace inery {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::inery::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::inery::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::inery::ignore<T>&) {
     return ds;
   }
}
