...
namespace inery {
   ...
   /**
    *  Serialize an inery::webauthn_public_key into a stream
    *
    *  @ingroup public_key
   ...
   inline DataStream& operator<<(DataStream& ds, const inery::webauthn_public_key& pubkey) {
      ds << pubkey.key << pubkey.user_presence << pubkey.rpid;
      return ds;
   }

   /**
    *  Deserialize an inery::webauthn_public_key from a stream
    *
    *  @ingroup public_key
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, inery::webauthn_public_key& pubkey) {
      ds >> pubkey.key >> pubkey.user_presence >> pubkey.rpid;
      return ds;
   }
   ...
   /**
    *  Serialize an inery::webauthn_signature into a stream
    *
    *  @param ds - The stream to write
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const inery::webauthn_signature& sig) {
      ds << sig.compact_signature << sig.auth_data << sig.client_json;
      return ds;
   }

   /**
    *  Deserialize an inery::webauthn_signature from a stream
    *
    *  @param ds - The stream to read
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, inery::webauthn_signature& sig) {
      ds >> sig.compact_signature >> sig.auth_data >> sig.client_json;
      return ds;
   }
    ...
    */
   void assert_sha256( const char* data, uint32_t length, const inery::checksum256& hash );
    ...
    *  @note This method is optimized to a NO-OP when in fast evaluation mode.
    */
   void assert_sha1( const char* data, uint32_t length, const inery::checksum160& hash );
    ...
    *  @note This method is optimized to a NO-OP when in fast evaluation mode.
    */
   void assert_sha512( const char* data, uint32_t length, const inery::checksum512& hash );
    ...
    *  @param hash - digest to compare to
    */
   void assert_ripemd160( const char* data, uint32_t length, const inery::checksum160& hash );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return inery::checksum256 - Computed digest
    */
   inery::checksum256 sha256( const char* data, uint32_t length );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return inery::checksum160 - Computed digest
    */
   inery::checksum160 sha1( const char* data, uint32_t length );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return inery::checksum512 - Computed digest
    */
   inery::checksum512 sha512( const char* data, uint32_t length );
    ...
    *  @return inery::checksum160 - Computed digest
    */
   inery::checksum160 ripemd160( const char* data, uint32_t length );
    ...
    *  @param sig - Signature
    *  @return inery::public_key - Recovered public key
    */
   inery::public_key recover_key( const inery::checksum256& digest, const inery::signature& sig );
    ...
    */
   void assert_recover_key( const inery::checksum256& digest, const inery::signature& sig, const inery::public_key& pubkey );
}
