/**
 *  @file
 *  @copyright defined in inery.cdt/LICENSE.txt
 */
...
#include "datastream.hpp" // inery::datastream
#include "varint.hpp"     // inery::unsigned_int
...
namespace inery {
   ...
   public:
      ...
      char& at(const size_t n) {
         inery::check(0 <= n && n < _size, "inery::string::at");
         return operator[](n);
      }

      const char at(const size_t n) const {
         inery::check(0 <= n && n < _size, "inery::string::at const");
         return operator[](n);
      }
      ...
      size_t copy(char* s, size_t len, size_t pos = 0) const {
         inery::check(pos <= _size, "inery::string::copy");
      ...
      string& insert(const size_t pos, const char* str, const size_t len) {
         inery::check((str != nullptr) && (0 <= pos && pos <= _size), "inery::string::insert");
      ...
      string& erase(size_t pos = 0, size_t len = npos) {
         inery::check(0 <= pos && pos <= _size, "inery::string::erase");
      ...
      string& append(const char* str) {
         inery::check(str != nullptr, "inery::string::append");
         insert(_size, str);
