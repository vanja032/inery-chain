...
/**
 * INERY Public Key. K1 and R1 keys are 34 bytes.  Newer keys can be variable-sized
 */
...
/**
 * INERY Signature. K1 and R1 signatures are 66 bytes. Newer signatures can be variable-sized
 */
