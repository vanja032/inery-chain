 ...
 *  inery::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  inery::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((inery_wasm_import))
 ...
 *  inery::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((inery_wasm_import))
 ...
 *  inery::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((inery_wasm_import))
 ...
 *  ine_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
__attribute__((inery_wasm_import))
 ...
 *  inery::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
__attribute__((inery_wasm_import))
