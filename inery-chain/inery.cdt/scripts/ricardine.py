...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardine.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardine.py import /ine/contracts/contract/mycontract.abi /ine/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricardine.py export /ine/contracts/contract/mycontract.abi')
