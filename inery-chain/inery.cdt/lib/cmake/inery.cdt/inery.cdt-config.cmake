if(INERY_CDT_ROOT STREQUAL "" OR NOT INERY_CDT_ROOT)
   set(INERY_CDT_ROOT "/petar/inery.cdt/build")
endif()

list(APPEND CMAKE_MODULE_PATH ${INERY_CDT_ROOT}/lib/cmake/inery.cdt)
if (NOT INERY_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(INERY_WASM_OLD_BEHAVIOR "On")
    include(IneryWasmToolchain)
endif()
...
function(INERY_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(INERY_CHECK_VERSION)
